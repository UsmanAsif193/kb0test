      ...
      <td className="whitespace-nowrap  font-normal text-gray-900">
        <div className="kb-name flex align-center">
          ...
          <div>
            ...
            >
              <Link href={`/knowledge-base/kb/detail/${item.id}`}>
                <a> {item.name}</a>
              </Link>
            </span>
            <div className={`flex flex-row`}>
              ...
              >{`${item.stat?.num_categories + " Categories"}`}</span>
              &nbsp;&nbsp;
              <span
                className={`hover:underline hover:text-lightgreen hover:cursor-pointer text-xs `}
              >{`0 Articles`}</span>
        ...
        <div className="icon-center">
          <span
            className={`h-[16px] w-[16px] ${
              item.active ? "bg-red-600" : "bg-blue-600"
            } border-black border-1 rounded-full cursor-pointer `}
          ></span>
        </div>
      </td>
      <td>
