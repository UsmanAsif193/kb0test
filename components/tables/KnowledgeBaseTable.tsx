              ...
              <SortableContainerWidget onSortEnd={onSortEnd} useDragHandle>
                <thead className="bg-gray-50">
                  <tr>
                    <th
                      scope="col"
                      className="text-center font-medium text-gray-500 w-[40px]"
                    ></th>
                    <th
                      scope="col"
                      className="w-[80px] text-center font-medium text-gray-500  "
                    >
                      #
                    </th>
                    <th
                    ...
                    <th
                      scope="col"
                      className="w-[100px] text-center font-medium text-gray-500  "
                    >
                      Status
                    </th>
                    <th
                ...
                <tbody className="bg-white">
                  {tableData?.map((item, i) => (
                    <KnowledgeBaseItem key={i} value={item} />
                  ))}
                </tbody>
