...
interface TextModulesTableProps {}

const TextModulesTable: FC<TextModulesTableProps> = () => {
  return (
    <>
      <div className="module-heading mb-3">Text Modules</div>
          ...
          <div className={`grid md:grid-cols-3 lg:basis-1/2 basis-full gap-5 `}>
            <div className="md:col-span-2 flex flex-row rounded-md overflow-hidden shadow-sm thinBorder ">
              ...
              <input
                ...
                placeholder={"Search for Text Modules"}
              />
            </div>
          </div>
              ...
              <div className="shadow overflow-hidden sm:rounded-lg">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{"dmr - Dear Mr. #{ticket.customer.lastname},"}</td>
                      <td>-</td>
                      <td>I could not reach you by phone. Could you pleas</td>
                      <td>-</td>
                      <td className="text-right">
                        <span className={`icon-right`}>
                          <PencilAltIcon
...
export default TextModulesTable;
