      ...
      <div className="lg:max-w-4xl xl:max-w-5xl">
        <div className={`w-full flex flex-col`}>
          ...
          >
            ...
            <div className={`flex-grow-0 w-52 flex flex-row justify-between ml-16`}>
          ...
          {languages.map((item: any, index: any) => (
            ...
            >
              ...
              <div className={`flex-grow-0 w-52 flex flex-row justify-between md:ml-16`}>
                <div className="w-1/2 flex flex-col items-center">
                  <input
          ...
          <div className={`flex flex-col w-full py-6`}>
            ...
            <div className="form-floating my-4 ">
              <textarea
                ...
                id="footer"
                placeholder="Footer"
                onChange={(e) => setData({ ...(data as any), footer: e.target.value })}
